...
const mongoDbAggregation=async(req,res)=>{
    try{
       ...
       let result= await userModel.aggregate([
            ...
            ,
            {
                $project:{__v:0,"productDetails.__v":0}
            }
          ])
...
module.exports = { createProduct,getProduct,deleteProduct,updateProduct,getProductById ,mongoDbAggregation}